...
export default {
  ...
  data() {
    return {
      ...
      chat: {
        ...
        peer: null,         // active practitioner
        input: '',          // textarea input
        messages: [],       // message list
      },

      /* Practitioners list — extend as needed */
      practitioners: [
        {
          id: 1,
          name: 'Marcus Johnson',
          type: 'Vinyasa Instructor',
          email: 'marcus.johnson@example.com',
          phone: '+1 (415) 555-0134',
          responseTime: 2,
          short: 'Alignment, breath, and mindful flow for all levels.',
          avatar: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 2,
          name: 'Emma Rodriguez',
          type: 'Ashtanga Teacher',
          email: 'emma.rod@example.com',
          phone: '+1 (512) 555-0148',
          responseTime: 1,
          short: 'Dynamic flows that build strength and mobility.',
          avatar: 'https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 3,
          name: 'Sarah Chen',
          type: 'Restorative Guide',
          email: 'sarah.chen@example.com',
          phone: '+1 (206) 555-0172',
          responseTime: 3,
          short: 'Gentle, restorative practices for recovery and stress relief.',
        ...
        },
        {
          ...
          responseTime: 5,
          short: 'Traditional Hatha with Iyengar alignment cues.',
          avatar: 'https://images.unsplash.com/photo-1546525848-3ce03ca516f6?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 5,
          name: 'Anya Petrov',
          type: 'Power Yoga Coach',
          email: 'anya.petrov@example.com',
          phone: '+48 22 555 0101',
          responseTime: 6,
          short: 'Playful flows with strength work and mindful cooldowns.',
          avatar: 'https://images.unsplash.com/photo-1541534401786-2077eed87a72?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 6,
          name: 'Diego Alvarez',
          type: 'Ashtanga / Vinyasa',
          email: 'diego.alvarez@example.com',
          phone: '+34 91 555 0167',
          responseTime: 1,
          short: 'Ashtanga-inspired sequences with attention to breath.',
          avatar: 'https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 7,
          name: 'Priya Sharma',
          type: 'Kundalini Specialist',
          email: 'priya.sharma@example.com',
          phone: '+91 99888 22110',
          responseTime: 4,
          short: 'Kundalini kriyas and meditations for energy balancing.',
          avatar: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 8,
          name: 'Lucas Meyer',
          type: 'Yin & Restorative',
          email: 'lucas.meyer@example.com',
          phone: '+49 30 555 0199',
          responseTime: 2,
          short: 'Slow, deep holds to improve flexibility and calm the mind.',
          avatar: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 9,
          name: 'Naomi Sato',
          type: 'Iyengar Alignment',
          email: 'naomi.sato@example.com',
          phone: '+81 3 5550 1188',
          responseTime: 3,
          short: 'Precision, props, and posture education for safe practice.',
        ...
        },
        {
          ...
          phone: '+44 20 5550 5511',
          responseTime: 4,
          short: 'Supportive prenatal sequences tailored by trimester.',
          avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 11,
          ...
          phone: '+39 06 555 2300',
          responseTime: 2,
          short: 'Balanced sequences focusing on mindful movement.',
          avatar: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=300&auto=format&fit=crop',
        },
        {
          id: 12,
          ...
          phone: '+55 11 5550 4422',
          responseTime: 1,
          short: 'Athletic sequences that build stamina with breath work.',
          avatar: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=300&auto=format&fit=crop',
        },
      ],
    };
  ...
  /* --------------------------------------------------------------
     Methods (UI actions, helpers)
     -------------------------------------------------------------- */
  methods: {
    /* Quick chat opens the first available profile */
    openQuickChat() {
      const first = this.practitioners[0];
      if (first) this.openChat(first);
    },

    /* Open chat with selected practitioner */
    openChat(p) {
      this.chat.open = true;
      this.chat.peer = p;
      // Seed welcome message each time a chat opens
      this.chat.messages = [
    ...
    /* Close chat modal and reset input */
    closeChat() {
    ...
    /* Send a chat message, simulate an automated response */
    sendChat() {
      ...
      setTimeout(() => {
        ...
        this.chat.messages.push({ id: Date.now() + 1, text: 'Thanks for your message! I will get back shortly.', time: this.fmtTime(new Date()), mine: false });
        this.$nextTick(() => this.scrollChatToEnd());
      }, 850);
    },

    /* Keep messages scrolled to the end after updates */
    scrollChatToEnd() {
      const scroller = this.$refs.chatScroll;
      if (scroller) scroller.scrollTop = scroller.scrollHeight;
    },

    /* Format a time for message timestamps */
    fmtTime(d) {
      try {
    ...
    /* Copy a single practitioner's contact block */
    copyContacts(p) {
      const text = `${p.name}\n${p.type}\nEmail: ${p.email}\nPhone: ${p.phone}`;
    ...
    /* Copy all visible practitioners to clipboard */
    copyAllContacts() {
    ...
    /* Map yogi type to a badge color */
    yogiTypeClass(type) {
      const map = [
